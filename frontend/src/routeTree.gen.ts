...
import { Route as LayoutBooksAddRouteImport } from './routes/_layout/books/add'
...
const LayoutBooksAddRoute = LayoutBooksAddRouteImport.update({
  id: '/books/add',
  path: '/books/add',
  getParentRoute: () => LayoutRoute,
} as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_layout/books/add': {
      ...
      path: '/books/add'
      fullPath: '/books/add'
      preLoaderRoute: typeof LayoutBooksAddRouteImport
      parentRoute: typeof LayoutRoute
    }
  }
}
